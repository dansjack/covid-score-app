 ...
 */
public class LocationSelectionFragment extends Fragment implements AdapterView.OnItemSelectedListener {
    /**
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        ArrayAdapter<CharSequence> state_adapter = ArrayAdapter.createFromResource(this.getActivity(),
        ...
        // Create an ArrayAdapter using the string array and a default spinner layout
        ArrayAdapter<CharSequence> county_adapter = ArrayAdapter.createFromResource(this.getActivity(),
        ...
        // Apply the adapter to the spinner
        county_spinner = (Spinner) v.findViewById(R.id.county_spinner);
